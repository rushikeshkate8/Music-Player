package code.name.player.musicplayer.rest.service;

import code.name.player.musicplayer.rest.model.KuGouRawLyric;
import code.name.player.musicplayer.rest.model.KuGouSearchLyricResult;
