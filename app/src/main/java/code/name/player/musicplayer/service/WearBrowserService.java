    ...
    private void addMediaRoots(List<MediaBrowser.MediaItem> mMediaRoot) {
        ...
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://code.name.player.musicplayer/drawable/ic_queue_music_white_24dp"))
                        ...
                        case TYPE_ARTIST:
                            ...
                            for (Artist artist : artistList) {
                                ...
                                fillMediaItems(mediaItems,
                                        ...
                                        Uri.parse("android.resource://code.name.player.musicplayer/drawable/default_artist_art"),
                        ...
                        case TYPE_SONG:
                            ...
                            for (Song song : songList) {
                                fillMediaItems(mediaItems,
                                        ...
                                        song.title,
                                        song.albumName,
                                        Uri.parse("android.resource://code.name.player.musicplayer/drawable/default_album_art"),
                        ...
                        case TYPE_PLAYLIST:
                            ...
                            for (Playlist playlist : playlistList) {
                                ...
                                fillMediaItems(mediaItems,
                                        ...
                                        playlist.name,
                                        songCount,
                                        Uri.parse("android.resource://code.name.player.musicplayer/drawable/ic_queue_music_white_24dp"),
                                        MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
