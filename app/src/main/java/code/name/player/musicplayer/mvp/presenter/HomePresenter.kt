...
import code.name.player.musicplayer.ui.adapter.HomeAdapter.Companion.GENRES
import code.name.player.musicplayer.ui.adapter.HomeAdapter.Companion.PLAYLISTS
import code.name.player.musicplayer.ui.adapter.HomeAdapter.Companion.RECENT_ALBUMS
import code.name.player.musicplayer.ui.adapter.HomeAdapter.Companion.RECENT_ARTISTS
import code.name.player.musicplayer.ui.adapter.HomeAdapter.Companion.SUGGESTIONS
import code.name.player.musicplayer.ui.adapter.HomeAdapter.Companion.TOP_ALBUMS
import code.name.player.musicplayer.ui.adapter.HomeAdapter.Companion.TOP_ARTISTS
