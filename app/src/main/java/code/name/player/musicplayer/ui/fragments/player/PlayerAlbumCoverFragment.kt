package code.name.player.musicplayer.ui.fragments.player
...
import code.name.player.musicplayer.transform.CarousalPagerTransformer
import code.name.player.musicplayer.transform.ParallaxPagerTransformer
import code.name.player.musicplayer.ui.adapter.album.AlbumCoverPagerAdapter
