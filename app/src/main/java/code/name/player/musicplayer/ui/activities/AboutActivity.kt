...
import code.name.player.musicplayer.Constants.APP_INSTAGRAM_LINK
import code.name.player.musicplayer.Constants.APP_TELEGRAM_LINK
import code.name.player.musicplayer.Constants.APP_TWITTER_LINK
import code.name.player.musicplayer.Constants.DISCORD_LINK
import code.name.player.musicplayer.Constants.FAQ_LINK
import code.name.player.musicplayer.Constants.GITHUB_PROJECT
import code.name.player.musicplayer.Constants.GOOGLE_PLUS_COMMUNITY
import code.name.player.musicplayer.Constants.PINTEREST
import code.name.player.musicplayer.Constants.RATE_ON_GOOGLE_PLAY
import code.name.player.musicplayer.Constants.TELEGRAM_CHANGE_LOG
import code.name.player.musicplayer.Constants.TRANSLATE
...
import code.name.player.musicplayer.ui.adapter.ContributorAdapter
