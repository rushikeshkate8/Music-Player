...
import code.name.player.musicplayer.ui.fragments.MiniPlayerFragment
import code.name.player.musicplayer.ui.fragments.NowPlayingScreen
import code.name.player.musicplayer.ui.fragments.base.AbsPlayerFragment
import code.name.player.musicplayer.ui.fragments.player.adaptive.AdaptiveFragment
import code.name.player.musicplayer.ui.fragments.player.blur.BlurPlayerFragment
import code.name.player.musicplayer.ui.fragments.player.card.CardFragment
import code.name.player.musicplayer.ui.fragments.player.cardblur.CardBlurFragment
import code.name.player.musicplayer.ui.fragments.player.color.ColorFragment
import code.name.player.musicplayer.ui.fragments.player.fit.FitFragment
import code.name.player.musicplayer.ui.fragments.player.flat.FlatPlayerFragment
import code.name.player.musicplayer.ui.fragments.player.full.FullPlayerFragment
import code.name.player.musicplayer.ui.fragments.player.material.MaterialFragment
import code.name.player.musicplayer.ui.fragments.player.normal.PlayerFragment
import code.name.player.musicplayer.ui.fragments.player.plain.PlainPlayerFragment
import code.name.player.musicplayer.ui.fragments.player.simple.SimplePlayerFragment
import code.name.player.musicplayer.util.PreferenceUtil
import code.name.player.musicplayer.views.BottomNavigationBarTinted
