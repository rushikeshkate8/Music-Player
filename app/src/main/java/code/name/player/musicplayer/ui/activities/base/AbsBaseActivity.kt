...
abstract class AbsBaseActivity : AbsThemeActivity() {
    ...
    fun getPermissionDeniedMessage(): String {
        return if (permissionDeniedMessage == null) getString(code.name.player.musicplayer.R.string.permissions_denied) else permissionDeniedMessage!!
    }
                ...
                if (grantResult != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this@AbsBaseActivity,
                        ...
                        Snackbar.make(snackBarContainer, permissionDeniedMessage!!,
                                ...
                                .setAction(code.name.player.musicplayer.R.string.action_grant) { requestPermissions() }
                        ...
                        Snackbar.make(snackBarContainer, permissionDeniedMessage!!,
                                Snackbar.LENGTH_INDEFINITE)
                                .setAction(code.name.player.musicplayer.R.string.action_settings) {
                                    val intent = Intent()
