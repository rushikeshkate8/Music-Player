package code.name.player.musicplayer.service;
...
import code.name.player.musicplayer.appwidgets.AppWidgetClassic;
import code.name.player.musicplayer.appwidgets.AppWidgetSmall;
import code.name.player.musicplayer.appwidgets.AppWidgetText;
import code.name.player.musicplayer.glide.BlurTransformation;
import code.name.player.musicplayer.glide.GlideApp;
import code.name.player.musicplayer.glide.GlideRequest;
import code.name.player.musicplayer.glide.RetroGlideExtension;
import code.name.player.musicplayer.glide.RetroSimpleTarget;
import code.name.player.musicplayer.helper.ShuffleHelper;
import code.name.player.musicplayer.helper.StopWatch;
...
import code.name.player.musicplayer.providers.MusicPlaybackQueueStore;
import code.name.player.musicplayer.providers.SongPlayCountStore;
import code.name.player.musicplayer.service.notification.PlayingNotification;
import code.name.player.musicplayer.service.notification.PlayingNotificationImpl24;
import code.name.player.musicplayer.service.notification.PlayingNotificationOreo;
...
import static code.name.player.musicplayer.Constants.ACTION_QUIT;
import static code.name.player.musicplayer.Constants.ACTION_REWIND;
import static code.name.player.musicplayer.Constants.ACTION_SKIP;
import static code.name.player.musicplayer.Constants.ACTION_STOP;
import static code.name.player.musicplayer.Constants.ACTION_TOGGLE_PAUSE;
import static code.name.player.musicplayer.Constants.APP_WIDGET_UPDATE;
import static code.name.player.musicplayer.Constants.EXTRA_APP_WIDGET_NAME;
import static code.name.player.musicplayer.Constants.INTENT_EXTRA_PLAYLIST;
import static code.name.player.musicplayer.Constants.INTENT_EXTRA_SHUFFLE_MODE;
import static code.name.player.musicplayer.Constants.MEDIA_STORE_CHANGED;
import static code.name.player.musicplayer.Constants.META_CHANGED;
import static code.name.player.musicplayer.Constants.MUSIC_PACKAGE_NAME;
import static code.name.player.musicplayer.Constants.PLAY_STATE_CHANGED;
import static code.name.player.musicplayer.Constants.QUEUE_CHANGED;
import static code.name.player.musicplayer.Constants.REPEAT_MODE_CHANGED;
...
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public void onCreate() {
        ...
        sendBroadcast(new Intent("code.name.player.musicplayer.RETRO_MUSIC_SERVICE_CREATED"));
    ...
    public void onDestroy() {
        ...
        sendBroadcast(new Intent("code.name.player.musicplayer.RETRO_MUSIC_MUSIC_SERVICE_DESTROYED"));
    }
