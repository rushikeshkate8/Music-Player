...
object Constants {
    ...
    @JvmField
    val RETRO_MUSIC_PACKAGE_NAME = "code.name.player.musicplayer"
    @JvmField
    ...
    @JvmField
    val RATE_ON_GOOGLE_PLAY = "https://play.google.com/store/apps/details?id=code.name.player.musicplayer"
    @JvmField
