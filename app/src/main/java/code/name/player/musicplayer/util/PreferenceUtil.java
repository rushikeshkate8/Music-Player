...
import code.name.player.musicplayer.transform.CascadingPageTransformer;
import code.name.player.musicplayer.transform.DepthTransformation;
import code.name.player.musicplayer.transform.HingeTransformation;
import code.name.player.musicplayer.transform.HorizontalFlipTransformation;
import code.name.player.musicplayer.transform.NormalPageTransformer;
import code.name.player.musicplayer.transform.StackTransformer;
import code.name.player.musicplayer.transform.VerticalFlipTransformation;
import code.name.player.musicplayer.ui.activities.MainActivity;
import code.name.player.musicplayer.ui.fragments.AlbumCoverStyle;
