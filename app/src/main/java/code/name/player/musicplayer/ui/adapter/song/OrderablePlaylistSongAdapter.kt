...
import code.name.player.musicplayer.dialogs.RemoveFromPlaylistDialog
...
class OrderablePlaylistSongAdapter(activity: AppCompatActivity,
    ...
    init {
        setMultiSelectMenuRes(code.name.player.musicplayer.R.menu.menu_playlists_songs_selection)
    }
    ...
    inner class ViewHolder(itemView: View) : PlaylistSongAdapter.ViewHolder(itemView), DraggableItemViewHolder {
        ...
        override var songMenuRes: Int
            get() = code.name.player.musicplayer.R.menu.menu_item_playlist_song
            set(value) {
        ...
        override fun onSongMenuItemClick(item: MenuItem): Boolean {
            when (item.itemId) {
                code.name.player.musicplayer.R.id.action_remove_from_playlist -> {
